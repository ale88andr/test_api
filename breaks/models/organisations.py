...
class Organisation(models.Model):
    ...
    director = models.ForeignKey(User, models.RESTRICT, 'organisation_directors', verbose_name='Директор')
    employees = models.ManyToManyField(User, 'organisation_employees', verbose_name='Сотрудники', blank=True)
...
class Group(models.Model):
    organisation = models.ForeignKey('breaks.Organisation', models.CASCADE, 'groups', verbose_name='Организация')
    name = models.CharField('Наименование', max_length=255)
    manager = models.ForeignKey(User, models.RESTRICT, 'group_managers', verbose_name='Менеджер')
